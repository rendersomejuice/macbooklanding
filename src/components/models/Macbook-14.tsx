...
Files: macbook-14.glb [629.72KB] > C:\CURSOWEB\trheejs1\macbooklanding\public\models\macbook-14-transformed.glb [627.9KB] (0%)
...
export default function MacbookModel14(props: React.JSX.IntrinsicElements['group']) {
  const { nodes, materials, scene } = useGLTF(import.meta.env.BASE_URL +'models/macbook-14-transformed.glb') as unknown as GLTFResult
